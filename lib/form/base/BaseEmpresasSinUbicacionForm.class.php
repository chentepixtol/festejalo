...
/**
 * EmpresasSinUbicacion form base class.
 *
 * @package    festejalo
 * @subpackage form
 ...
 */
class BaseEmpresasSinUbicacionForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                 => new sfValidatorPropelChoice(array('model' => 'EmpresasSinUbicacion', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('empresas_sin_ubicacion[%s]');
