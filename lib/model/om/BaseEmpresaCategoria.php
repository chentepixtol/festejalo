...
/**
 * Base class that represents a row from the 'empresa_categoria' table.
 *
 * 
 *
 ...
 */
abstract class BaseEmpresaCategoria extends BaseObject  implements Persistent {


  const PEER = 'EmpresaCategoriaPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        EmpresaCategoriaPeer
	 */
	...
	/**
	 * Initializes internal state of BaseEmpresaCategoria object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     EmpresaCategoria The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = EmpresaCategoriaPeer::ID;
		}
	...
	public function setEmpresaId($v)
	{
		...
		if ($this->empresa_id !== $v) {
			$this->empresa_id = $v;
			$this->modifiedColumns[] = EmpresaCategoriaPeer::EMPRESA_ID;
		}
	...
	public function setCategoriaId($v)
	{
		...
		if ($this->categoria_id !== $v) {
			$this->categoria_id = $v;
			$this->modifiedColumns[] = EmpresaCategoriaPeer::CATEGORIA_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = EmpresaCategoriaPeer::NUM_COLUMNS - EmpresaCategoriaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EmpresaCategoria object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EmpresaCategoriaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseEmpresaCategoria:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			EmpresaCategoriaPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseEmpresaCategoria:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseEmpresaCategoria:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseEmpresaCategoria:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			EmpresaCategoriaPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = EmpresaCategoriaPeer::doInsert($this, $con);
					...
					$affectedRows += EmpresaCategoriaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EmpresaCategoriaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EmpresaCategoriaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EmpresaCategoriaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmpresaCategoriaPeer::ID)) $criteria->add(EmpresaCategoriaPeer::ID, $this->id);
		if ($this->isColumnModified(EmpresaCategoriaPeer::EMPRESA_ID)) $criteria->add(EmpresaCategoriaPeer::EMPRESA_ID, $this->empresa_id);
		if ($this->isColumnModified(EmpresaCategoriaPeer::CATEGORIA_ID)) $criteria->add(EmpresaCategoriaPeer::CATEGORIA_ID, $this->categoria_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EmpresaCategoriaPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EmpresaCategoria (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EmpresaCategoria Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EmpresaCategoriaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EmpresaCategoriaPeer();
		}
		return self::$peer;
	}
	...
	public function getEmpresa(PropelPDO $con = null)
	{
		if ($this->aEmpresa === null && ($this->empresa_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEmpresa->addEmpresaCategorias($this);
			 */
		}
	...
	public function getCategoria(PropelPDO $con = null)
	{
		if ($this->aCategoria === null && ($this->categoria_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCategoria->addEmpresaCategorias($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseEmpresaCategoria:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseEmpresaCategoria::%s', $method));
    }
