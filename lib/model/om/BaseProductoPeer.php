...
abstract class BaseProductoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Producto';
	...
	/** the column name for the MINIATURA field */
	const MINIATURA = 'producto.MINIATURA';

	/** the column name for the SLOT field */
	const SLOT = 'producto.SLOT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'EmpresaId', 'CategoriaId', 'Nombre', 'Descripcion', 'Foto', 'Miniatura', 'Slot', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'empresaId', 'categoriaId', 'nombre', 'descripcion', 'foto', 'miniatura', 'slot', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMPRESA_ID, self::CATEGORIA_ID, self::NOMBRE, self::DESCRIPCION, self::FOTO, self::MINIATURA, self::SLOT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'empresa_id', 'categoria_id', 'nombre', 'descripcion', 'foto', 'miniatura', 'slot', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'EmpresaId' => 1, 'CategoriaId' => 2, 'Nombre' => 3, 'Descripcion' => 4, 'Foto' => 5, 'Miniatura' => 6, 'Slot' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'empresaId' => 1, 'categoriaId' => 2, 'nombre' => 3, 'descripcion' => 4, 'foto' => 5, 'miniatura' => 6, 'slot' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMPRESA_ID => 1, self::CATEGORIA_ID => 2, self::NOMBRE => 3, self::DESCRIPCION => 4, self::FOTO => 5, self::MINIATURA => 6, self::SLOT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'empresa_id' => 1, 'categoria_id' => 2, 'nombre' => 3, 'descripcion' => 4, 'foto' => 5, 'miniatura' => 6, 'slot' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ProductoMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProductoPeer::FOTO);

		$criteria->addSelectColumn(ProductoPeer::MINIATURA);

		$criteria->addSelectColumn(ProductoPeer::SLOT);
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseProductoPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseProductoPeer', $criteria, $con);
    }
	 ...
	 */
	public static function addInstanceToPool(Producto $obj, $key = null)
	{
	...
	public static function doCountJoinEmpresa(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProductoPeer::EMPRESA_ID,), array(EmpresaPeer::ID,), $join_behavior);
	...
	public static function doCountJoinCategoria(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProductoPeer::CATEGORIA_ID,), array(CategoriaPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseProductoPeer', $c, $con);
    }
		...
		$startcol = (ProductoPeer::NUM_COLUMNS - ProductoPeer::NUM_LAZY_LOAD_COLUMNS);
		EmpresaPeer::addSelectColumns($c);

		$c->addJoin(array(ProductoPeer::EMPRESA_ID,), array(EmpresaPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinCategoria(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(ProductoPeer::CATEGORIA_ID,), array(CategoriaPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseProductoPeer', $c, $con);
    }
		...
		ProductoPeer::addSelectColumns($c);
		$startcol2 = (ProductoPeer::NUM_COLUMNS - ProductoPeer::NUM_LAZY_LOAD_COLUMNS);
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseProductoPeer', $c, $con);
    }
	...
	/**
	 * Selects a collection of Producto objects pre-filled with all related objects except Categoria.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return ProductoPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseProductoPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseProductoPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseProductoPeer', $values, $con);
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ProductoPeer::ID, $criteria->remove(ProductoPeer::ID), $comparison);
    ...
    foreach (sfMixer::getCallables('BaseProductoPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseProductoPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ProductoPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Producto) {
	 ...
	 */
	public static function doValidate(Producto $obj, $cols = null)
	{
		$columns = array();
		...
		$res =  BasePeer::doValidate(ProductoPeer::DATABASE_NAME, ProductoPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = ProductoPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the ProductoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ProductoPeer class:
//
// Propel::getDatabaseMap(ProductoPeer::DATABASE_NAME)->addTableBuilder(ProductoPeer::TABLE_NAME, ProductoPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseProductoPeer::DATABASE_NAME)->addTableBuilder(BaseProductoPeer::TABLE_NAME, BaseProductoPeer::getMapBuilder());
