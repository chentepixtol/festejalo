...
abstract class BaseProducto extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProductoPeer';
	...
	/**
	 * The value for the miniatura field.
	 * @var        string
	 */
	protected $miniatura;
	...
	/**
	 * Get the [miniatura] column value.
	 * 
	 * @return     string
	 */
	...
	public function setFoto($v)
	{
		...
		if ($this->foto !== $v) {
			$this->foto = $v;
			$this->modifiedColumns[] = ProductoPeer::FOTO;
		}
	...
	/**
	 * Set the value of [miniatura] column.
	 * 
	 * @param      string $v new value
	 * @return     Producto The current object (for fluent API support)
	 */
	public function setMiniatura($v)
	{
		...
		if ($this->miniatura !== $v) {
			$this->miniatura = $v;
			$this->modifiedColumns[] = ProductoPeer::MINIATURA;
		}
	...
	public function setSlot($v)
	{
		...
		if ($this->slot !== $v) {
			$this->slot = $v;
			$this->modifiedColumns[] = ProductoPeer::SLOT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->miniatura = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->slot = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = ProductoPeer::NUM_COLUMNS - ProductoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setMiniatura($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductoPeer::FOTO)) $criteria->add(ProductoPeer::FOTO, $this->foto);
		if ($this->isColumnModified(ProductoPeer::MINIATURA)) $criteria->add(ProductoPeer::MINIATURA, $this->miniatura);
		if ($this->isColumnModified(ProductoPeer::SLOT)) $criteria->add(ProductoPeer::SLOT, $this->slot);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setMiniatura($this->miniatura);
