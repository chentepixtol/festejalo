...
abstract class BaseSegmentoPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SegmentoPeer::ID);

		$criteria->addSelectColumn(SegmentoPeer::NOMBRE);

		$criteria->addSelectColumn(SegmentoPeer::SLOT);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseSegmentoPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(SegmentoPeer::ID) && $criteria->keyContainsValue(SegmentoPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SegmentoPeer::ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseSegmentoPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SegmentoPeer::ID);
			$selectCriteria->add(SegmentoPeer::ID, $criteria->remove(SegmentoPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += SegmentoPeer::doOnDeleteCascade(new Criteria(SegmentoPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SegmentoPeer::ID, (array) $values, Criteria::IN);
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += SegmentoPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = SegmentoPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(SegmentoPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SegmentoPeer::DATABASE_NAME);
			$criteria->add(SegmentoPeer::ID, $pks, Criteria::IN);
