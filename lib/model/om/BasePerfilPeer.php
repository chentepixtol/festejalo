...
abstract class BasePerfilPeer {
	...
	const APELLIDO_PATERNO = 'sf_guard_user_profile.APELLIDO_PATERNO';

	/** the column name for the APELLIDO_MATERNO field */
	const APELLIDO_MATERNO = 'sf_guard_user_profile.APELLIDO_MATERNO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Nombre', 'ApellidoPaterno', 'ApellidoMaterno', 'Email', 'Telefono', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'nombre', 'apellidoPaterno', 'apellidoMaterno', 'email', 'telefono', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::NOMBRE, self::APELLIDO_PATERNO, self::APELLIDO_MATERNO, self::EMAIL, self::TELEFONO, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'nombre', 'apellido_paterno', 'apellido_materno', 'email', 'telefono', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Nombre' => 2, 'ApellidoPaterno' => 3, 'ApellidoMaterno' => 4, 'Email' => 5, 'Telefono' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'nombre' => 2, 'apellidoPaterno' => 3, 'apellidoMaterno' => 4, 'email' => 5, 'telefono' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::NOMBRE => 2, self::APELLIDO_PATERNO => 3, self::APELLIDO_MATERNO => 4, self::EMAIL => 5, self::TELEFONO => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'nombre' => 2, 'apellido_paterno' => 3, 'apellido_materno' => 4, 'email' => 5, 'telefono' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PerfilPeer::USER_ID);

		$criteria->addSelectColumn(PerfilPeer::NOMBRE);

		$criteria->addSelectColumn(PerfilPeer::APELLIDO_PATERNO);

		$criteria->addSelectColumn(PerfilPeer::APELLIDO_MATERNO);

		$criteria->addSelectColumn(PerfilPeer::EMAIL);

		$criteria->addSelectColumn(PerfilPeer::TELEFONO);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(PerfilPeer::USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Perfil objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Perfil objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
    ...
    foreach (sfMixer::getCallables('BasePerfilPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasePerfilPeer', $c, $con);
		...
		$c->addJoin(array(PerfilPeer::USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Perfil) to $obj2 (sfGuardUser)
				$obj2->addPerfil($obj1);
	...
	/**
	 * Selects a collection of Perfil objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
      ...
      call_user_func($callable, 'BasePerfilPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Perfil) to the collection in $obj2 (sfGuardUser)
				$obj2->addPerfil($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in EmpresasSinUbicacionPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			EmpresasSinUbicacionPeer::clearInstancePool();
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(EmpresaPeer::USER_ID, $obj->getUserId());
			$affectedRows += EmpresaPeer::doDelete($c, $con);

			// delete related EmpresasSinUbicacion objects
			$c = new Criteria(EmpresasSinUbicacionPeer::DATABASE_NAME);
			
			$c->add(EmpresasSinUbicacionPeer::USER_ID, $obj->getUserId());
			$affectedRows += EmpresasSinUbicacionPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
//
// NOTE: This static code cannot call methods on the PerfilPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the PerfilPeer class:
//
// Propel::getDatabaseMap(PerfilPeer::DATABASE_NAME)->addTableBuilder(PerfilPeer::TABLE_NAME, PerfilPeer::getMapBuilder());
//
