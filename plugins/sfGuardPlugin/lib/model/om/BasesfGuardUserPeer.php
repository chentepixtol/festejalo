  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in PerfilPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Perfil objects
			$c = new Criteria(PerfilPeer::DATABASE_NAME);
			
			$c->add(PerfilPeer::USER_ID, $obj->getId());
			$affectedRows += PerfilPeer::doDelete($c, $con);
